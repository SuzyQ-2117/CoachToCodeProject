    ...
    return (
        <div className="container">
            ...
            <div className="bottom-middle">
                <p>I could really do with writing a few more words in this section so that I can see what the page layout will look like. </p>
                <br />
                <p>I honestly have no idea what to expect going into my new lab. I've never worked in the Tech industry before so this is all new to me. I'm very excited to get started though!</p>
                <br />
                <p>I'm going to just keep writing words here. This whole page is looking a little bit death-by-words so I should probably add some images in here somewhere.</p>
                <br />
                <p>I don't enjoy the wall of words aesthetic!</p>
            </div>

            <div className="bottom-right">
                <h4>Career</h4>
                <ul>
                    <li>Telephone Banking Assistant</li>
                    <li>Connect Team Manager</li>
                    <li>Bereavement Specialist</li>
                    <li>Banking Consultant</li>
